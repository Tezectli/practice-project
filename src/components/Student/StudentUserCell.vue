...
<template>
  <div>
    <van-cell-group>
      <van-cell is-link size="large" to="/s/studentInfo">
        <template slot="title">
          <van-icon size="16px" class-prefix="zhsj-icon" name="user" />
          <span class="cell-title">我的信息</span>
        </template>
      </van-cell>
      ...
      <van-cell is-link size="large" @click="clearLogin">
        <template slot="title">
          <van-icon size="16px" class-prefix="zhsj-icon" name="Import" />
          <span class="cell-title">退出登陆</span>
        </template>
      </van-cell>
    </van-cell-group>
    <van-dialog
